                    ...
                    <div class='row' style=' margin: 10px; background: #eee; overflow:auto; padding:5px;'>
                        ...
                        <div class='col-md-12 '>
                            ...
                            <p class='text-center'><a
                                        href='{{Storage::disk(config('binshopsblog.blog_filesystem_disk'))->url($file['filename'])}}'
                                        target='_blank'>[link]</a> / <span
                                        class='btn btn-sm btn-primary'
                                        style='cursor: zoom-in;'
                                        onclick='show_uploaded_file_row("{{$id}}","{{Storage::disk(config('binshopsblog.blog_filesystem_disk'))->url($file['filename'])}}")'>show</span>
                            </p>
                        ...
                        <div class='col-md-6 {{$id}}' style='display:none;'>
                            <div style=''>
                                ...
                                <input type='text' readonly='readonly' class='form-control'
                                       value='{{Storage::disk(config('binshopsblog.blog_filesystem_disk'))->url($file['filename'])}}'>
                            </div>
                        </div>
                        <div class='col-md-6 {{$id}}' style='display:none;'>
                            ...
                            <div style=''>
                                ...
                                <input type='text' readonly='readonly' class='form-control'
                                       value='{{"<img src='".Storage::disk(config('binshopsblog.blog_filesystem_disk'))->url($file['filename'])."' alt='" . e($uploadedPhoto->image_title) . "' >"}}'>
                            </div>
                        </div>
                ...
                <div class='col-md-4'>
                    @if($smallest)
                        ...
                        <div style='text-align:center;'>
                            <a style='cursor: zoom-in;' href='{{Storage::disk(config('binshopsblog.blog_filesystem_disk'))->url($smallest['filename'])}}'
                               target='_blank'>
                                <img src='{{Storage::disk(config('binshopsblog.blog_filesystem_disk'))->url($smallest['filename'])}}'
